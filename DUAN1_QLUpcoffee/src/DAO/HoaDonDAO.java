...
public class HoaDonDAO implements InterfaceHoadon{
    ...
    public void insert(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(INSERT_SQL,Entity.getIdNhanVien() ,Entity.getNgayTao(),Entity.isTrangThai(),
    ...
    public void updateThanhToan(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(UPDATE_SQL_TrangThaiTT, Entity.isTrangThaiTT(),Entity.getIdHoaDon());
    }

    @Override
    public void delete(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(DELETE_SQL, Entity.getIdHoaDon());
    }
    public void updatekh(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(UPDATE_SQL_khachhang, Entity.getSDT(), Entity.getTen(), Entity.getTienShip(), Entity.getDiaChi(), Entity.getIdHoaDon());
    }
    @Override
    ...
    public void updateLydohuy(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(UPDATE_SQL_Ly_DO,Entity.getLyDoHuy(), Entity.getIdHoaDon());
    }

    @Override
    public void updateSLSPHUY(Hoadon Entity) {
        JDBCHelper.jdbcHelper.update(UPDATE_SQL_DEM_SP_HUY, Entity.getSlSanPhamHuy(),Entity.getIdHoaDon());
    }
